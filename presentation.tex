	...
	\begin{columns}[c] % Changed [T] to [c] for vertical centering
		\begin{column}{0.45\textwidth} % Slightly increased width
			...
			\begin{alertblock}{Modeling Implication}
				\footnotesize Naive all-zero baseline gives $\sim 70\%$ accuracy, so accuracy alone is misleading. We optimize \textbf{F$_{0.5}$} and model the two targets as multi-label/multi-task outputs.
			\end{alertblock}
		\end{column}
...
\begin{frame}
	...
	\centering
	\includegraphics[width=0.9\textwidth,height=0.75\textheight,keepaspectratio]{figures/extracted_img_13.png}\\
	...
	\begin{columns}[T]
		...
		\begin{column}{0.52\textwidth}
			...
			\begin{block}{Why Not Selected}
				\begin{itemize}
					\item Slight gain for \textbf{Income} vs tuned RF.

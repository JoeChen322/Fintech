...
\begin{frame}[shrink=12]
	...
	\begin{columns}[T]
		...
		\begin{column}{0.46\textwidth}
			\textbf{2D projections (Isolation Forest)}\\[2pt]
			\includegraphics[width=\linewidth]{figures/outliers_tsne.png}\\[2pt]
			{\scriptsize \textit{t-SNE projection:} outliers (red) form a sparse fringe around the main cluster (blue). No clear isolated sub-group.}
		\end{column}
	\end{columns}
\end{frame}
